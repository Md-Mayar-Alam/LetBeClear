...
public class ForgotPasswordEmailSender 
{
	...
	public void sendEmail(String mailToSend,String link)
	{
		try
		{
			...
			String subject="Please don't share this link with anyone";
			String messageText="Click the below link to change password \n"+link;
