...
import com.letbeclear.services.PostCommentsLikeService;
...
//	}
	...
	@CrossOrigin(origins="*")
	@RequestMapping(value="rest/comment/getComment/{postId}", method=RequestMethod.GET)
	public @ResponseBody PostCommentGetResponseDto getCommentsOnPost(@PathVariable("postId")int postId)
	{
		//int postId=postCommentDto.getPostId();
		//long userId=jwtUser.getUserId();
